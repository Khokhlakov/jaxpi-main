...
def get_config():
    ...
    eval.strategies = {"dd_mult_1075_N500": dict(surrogate="DD", inflation="multiplicative", params=dict(inflation_factor=1.075)),
                       "pi_mult_108_N500": dict(surrogate="PI", inflation="multiplicative", params=dict(inflation_factor=1.08)),
                       "pi_RB_full_1_50_N500": dict(surrogate="PI", inflation="route_b", params=dict(alpha=1.0, beta=50.0)),
                       "pi_RB_res_50_N500": dict(surrogate="PI", inflation="route_b", params=dict(alpha=0.0, beta=50.0)),
                       "pi_add_3_N500": dict(surrogate="PI", inflation="additive", params=dict(alpha=3.0)),
                       "pi_rtpp_0325_N500": dict(surrogate="PI", inflation="rtpp", params=dict(alpha_rtpp=0.325)),
                       "dd_rtpp_035_N500": dict(surrogate="DD", inflation="rtpp", params=dict(alpha_rtpp=0.35)),
                       }

    eval.plot_groups = [["dd_mult_1075_N500", "pi_mult_108_N500"],
                        ["pi_rtpp_0325_N500", "dd_rtpp_035_N500"],
                        ["pi_mult_108_N500", "pi_RB_full_1_50_N500", "pi_RB_res_50_N500", "pi_add_3_N500", "pi_rtpp_0325_N500"]
                        ]
