...
def get_config():
    ...
    config.mode = "eval_ekf"

    # Weights & Biases
    # config 5 of v6 f2
    config.wandb = wandb = ml_collections.ConfigDict()
    wandb.project = "PI-UDON-L96-n40-f2-ics"
    wandb.name = "test_1_2_ekf_3" 
    wandb.ckpt_name = "test_1_2" 
    wandb.tag = None
    ...
    weighting.init_weights = ml_collections.ConfigDict({"ics": 7000.0, "res": 1.0}) 
    ...
    config.ekf.obs_interval = 3
    config.ekf.dynamic_vars = True # True -> randpick vars
