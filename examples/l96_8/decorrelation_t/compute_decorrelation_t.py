...
def compute_and_plot_l96_decorrelation(
        ...
        T_total=1000.0, 
        T_transient=300.0, 
        save_path="examples/l96_8/decorrelation_t/plot.pdf"
        ):
...
if __name__ == "__main__":
    compute_and_plot_l96_decorrelation(
        J=40, 
        F=5.0, 
        save_path="examples/l96_8/decorrelation_t/plot_5.pdf"
        )
    compute_and_plot_l96_decorrelation(
        J=40, 
        F=7.0, 
        save_path="examples/l96_8/decorrelation_t/plot_7.pdf"
        )
    compute_and_plot_l96_decorrelation(
        J=40, 
        F=8.0, 
        save_path="examples/l96_8/decorrelation_t/plot_8.pdf"
        )
    compute_and_plot_l96_decorrelation(
        J=40, 
        F=9.0, 
        save_path="examples/l96_8/decorrelation_t/plot_9.pdf"
        )