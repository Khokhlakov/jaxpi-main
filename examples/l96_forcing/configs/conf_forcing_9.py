...
def get_config():
    # Config 1 but init weights 1000:1 and using causal training
    ...
    wandb.name          = "test_forcing_9" 
    wandb.ckpt_name     = "test_forcing_9" 
    wandb.tag = None
    ...
    arch.fourier_emb = ml_collections.ConfigDict({"embed_scale": 13, "embed_dim": 1024})
