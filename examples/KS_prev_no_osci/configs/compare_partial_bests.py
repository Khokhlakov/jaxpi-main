...
def get_config():
    ...
    wandb.name          = "compare_partial_bests"
    wandb.ckpt_name     = "compare_partial_bests"
    wandb.tag = None
    ...
    eval.strategies = {
                ...
                "hy_add_1_ver_1":   dict(surrogate="HY", inflation="additive",
                                                params=dict(alpha=0.0)),
        
                "dd_mult_sweep_1_ver_1": dict(surrogate="DD", inflation="multiplicative",
                                params=dict(inflation_factor=1.02)),
        
                "pi_mult_sweep_1_ver_1": dict(surrogate="PI", inflation="multiplicative",
                                        params=dict(inflation_factor=1.02)),
                ...
                "dd_rtpp_sweep_1_ver_1": dict(surrogate="DD", inflation="rtpp",
                                        params=dict(alpha_rtpp=0.3)),
        
                "hy_rtpp_sweep_1_ver_1": dict(surrogate="HY", inflation="rtpp",
                                params=dict(alpha_rtpp=0.3)),
            }
    eval.plot_groups = [["hy_add_1_ver_1",
