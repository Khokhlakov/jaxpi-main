...
def get_config():
    ...
    wandb.name          = "compare_base_N500"
    wandb.ckpt_name     = "compare_base_N500"
    wandb.tag = None
    ...
    eval.strategies = {
        "dd_mult_sweep_1_N500": dict(surrogate="DD", inflation="multiplicative",
                        params=dict(inflation_factor=[1.05, 1.07, 1.075, 1.08, 1.1])),
        "hy_mult_sweep_1_N500": dict(surrogate="HY", inflation="multiplicative",
                        params=dict(inflation_factor=[1.06, 1.075, 1.08, 1.085, 1.1])),
        "pi_rb_res_sweep_1_N500":   dict(surrogate="PI", inflation="route_b",
                        params=dict(alpha=0.0, beta=[1e-2, 1e-1, 0.05, 0.1, 0.2])),
    }
