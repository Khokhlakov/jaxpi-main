...
def evaluate_with_ekf(config: ml_collections.ConfigDict, workdir: str):
    from examples.l96_6_larger_data.kf import EKFState, run_ekf_smoother
    import numpy as np
...
def _evaluate_batch_l2_ekf(
    ...
    """
    from examples.l96_6_larger_data.kf import run_ekf_smoother, EKFState
...
def evaluate_with_ekf_numerical(config: ml_collections.ConfigDict, workdir: str):
    ...
    """
    from examples.l96_6_larger_data.kf import make_ekf, run_ekf_smoother, EKFState
