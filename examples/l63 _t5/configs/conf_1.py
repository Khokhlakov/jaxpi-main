...
def get_config():
    ...
    weighting.init_weights = ml_collections.ConfigDict({"ics": 10.0, "res": 1.0}) #1.0, "res": 1.0})
    weighting.momentum = 0.9
    weighting.update_every_steps = 1000#1000

    weighting.use_causal = True
    weighting.causal_tol = 1.0
    weighting.num_chunks = 64#32
