...
def get_config():
    ...
    wandb.name = "test_18_2" 
    wandb.ckpt_name = "test_18" 
    wandb.tag = None
    ...
    weighting.init_weights = ml_collections.ConfigDict({"ics": 94.41337, "res": 0.50267}) 
    ...
    saving.restore_checkpoint_path = "test_17/ckpt/udon_model"
    saving.total_plots = 20
