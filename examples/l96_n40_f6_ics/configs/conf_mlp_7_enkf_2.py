...
def get_config():
    ...
    config.mode = "eval_mlp_enkf"

    # Weights & Biases
    config.wandb = wandb = ml_collections.ConfigDict()
    wandb.project   = "PI-UDON-L96-n40-f6-MLP"
    wandb.name      = "test_mlp_7_enkf_2"
    wandb.ckpt_name = "test_mlp_7_Adam"
    wandb.tag       = None
