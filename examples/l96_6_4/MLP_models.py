...
from examples.l96_6_4.utils import build_obs_schedule, scale_Q_for_fine_steps, get_dataset
from examples.l96_6_4.eval import (
    _load_l2_eval_pool,
    _plot_l2_per_window,
...
class L96MLP:
    ...
    def make_ekf_fns(self, params):
        ...
        """
        from examples.l96_6_4.kf import make_ekf
    ...
    def make_enkf_fns(self, params, N_ens: int = 50):
        ...
        """
        from examples.l96_6_4.kf import make_enkf
        propagator = self.make_surrogate_propagator(params)
...
def evaluate_mlp_with_ekf(config, workdir: str) -> None:
    ...
    """
    from examples.l96_6_4.kf import run_ekf_smoother
...
def evaluate_mlp_with_enkf(config, workdir: str) -> None:
    ...
    Args:
        ...
        workdir: root directory.
    """
    from examples.l96_6_4.kf import run_enkf_smoother, init_ensemble
