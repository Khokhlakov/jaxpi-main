...
def get_config():
    ...
    wandb.name          = "test_pi_11" # less reconditioning fixed weights 10 instead of 2
    wandb.ckpt_name     = "test_pi_11" 
    wandb.tag = None
    ...
    kf.obs_idx_list     = list(range(0, 256, 8))
